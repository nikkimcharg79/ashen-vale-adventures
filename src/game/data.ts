...
export const skills: Skill[] = [
  {
    ...
    cooldown: 0,
    multiplier: 1,
    description: "A swift, reliable cut.",
  },
  {
    id: "power",
    name: "Power Strike",
    ...
    cooldown: 2,
    multiplier: 1.65,
    description: "A heavy strike with high damage.",
  },
  {
    id: "moonveil",
    name: "Moonveil",
    ...
    cooldown: 3,
    multiplier: 1.35,
    description: "Moonlit steel with increased critical chance.",
  },
  {
    id: "shadow",
    name: "Shadow Step",
...
export const enemies = [
  {
    ...
    xp: 220,
    icon: "♠",
    flavor: "A masked outlaw draws steel beneath the pines.",
  },
  {
    name: "Ashen Wolf",
    maxHp: 175,
    ...
    xp: 190,
    icon: "♞",
    flavor: "An ember-eyed wolf prowls from the silver mist.",
  },
  {
